<template>
  <div class="flex justify-center px-4 sm:px-6 lg:px-8">
    <div
      class="overflow-x-auto max-w-4xl mt-5 w-full bg-primary-dark rounded-lg"
    >
     <!-- div to setup the background colour -->
      <div class="py-8 px-4 sm:px-6 lg:px-8 bg-primary-dark rounded-lg mx-8">
        <h1
          class="text-xl sm:text-2xl font-bold text-center text-bluegray-10 mb-5"
        >
          Task List
        </h1>
        ...
        <div class="relative overflow-x-auto shadow-lg sm:rounded-lg">
          ...
          <table class="w-full text-sm text-left">
            <thead
              class="text-xs sm:text-sm text-gray-700 uppercase bg-bluegray-15"
            >
              <tr>
            ...
            <tbody>
              <tr v-if="taskStore.tasks.length === 0" class="bg-bluegray-10">
                <td
                  colspan="5"
                  class="p-3 px-4 sm:px-6 py-4 text-sm font-medium text-center text-gray-700"
                >
                  No tasks available.
                </td>
              </tr>

              <!-- Handle the TaskItem Component -->
