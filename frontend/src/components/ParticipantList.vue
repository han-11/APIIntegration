            ...
            <tbody>
              ...
              <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                ...
                <td class="px-6 py-4">
                  ...
                  <button v-else @click="editParticipant(participant)" class="text-primary-iron hover:text-green-500 mr-2"><i class="pi pi-user-edit" style="font-size: 1rem"></i></button>
                  ...
                  <button @click="deleteParticipant(participant.id)" class="text-primary-iron hover:text-red-700 ml-3"><i class="pi pi-trash" style=" font-size: 1rem"></i></button>
                </td>
              </tr>
            </tbody>
          </table>
