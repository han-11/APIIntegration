  ...
  <div class="flex justify-center px-4 sm:px-6 lg:px-8">
      <div class="overflow-x-auto max-w-4xl mt-5 w-full bg-primary-dark shadow-md rounded-lg mx-8">
        ...
        <div class="py-10 px-10 inline-block min-w-full sm:px-4 lg:px-8 bg-primary-dark ">
          ...
          <div class="overflow-x-auto  py-8 px-4 sm:px-6 lg:px-8 bg-gray-700 rounded-lg mx-8">
          
          <form @submit.prevent="addTask">
            <!-- Task Name Input -->
            <div class="mb-4">
              <label class="block text-gray-300  font-semibold mb-2" for="taskName">Name:</label>
            ...
            <!-- Due Date Input -->
            <div class="mb-4">
              <label class="block text-gray-300 font-semibold mb-2" for="dueDate">Due Date:</label>
