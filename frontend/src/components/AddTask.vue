<template>
  <div class="flex justify-center px-4 sm:px-6 lg:px-8">
    ...
    >
      <div
        class="py-10 px-10 inline-block min-w-full sm:px-4 lg:px-8 bg-primary-dark"
      >
        ...
        <!-- Form To Add New Tasks -->
          <form @submit.prevent="addTask">
            ...
            <button
              type="submit"
              class="w-full bg-primary text-white font-semibold py-2 px-4 rounded-md hover:bg-primary-dark"
            >
              Add Task
            </button>
          </form>
